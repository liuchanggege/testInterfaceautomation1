...
data={"imageUrl": "http://tk.longpean.com/"+m,"linkUrl":itemurl,"developType":1,"note": "","simpleTitle": simpleTitle,"productNature":0,"station":"us", "detargetId":"","goodStore": 1,"dulizhanStore": 0,"amazonStore": 1}
...
# json3 = {'productSellingPoint': '', 'subSku': json.dumps(subSku), 'specialCount1': '', 'parentSku': FatherSKu,
...
#          'url': json.dumps(url), 'specialCount2': '', 'queryKey': '', 'znProductName': simpleTitle,
#          'cateIds': '208,508', 'radomDescriptionCn': '1111111', 'enProductTitle': 'a b c d e f g h i j k',
#          'productNewId': id, 'suitTarget2': '', 'keyword': 'a\nb\nc\nd\ne\nf\ng\nh\ni\nj\nk', 'aliasCnName': '111',
...
#      'sku': FatherSKu, 'inNetweight': 2, 'CostPrice': 2, 'bmpFile': 'No Image', 'goodsName': simpleTitle,
...
subsku = {"subSku": [
    {"subId": "", "sku": sku, "colour": "", "weight": 2, "size": "", "cost": 2, "startNum": 1, "inWide": "2",
     "inHigh": "2", "inLong": "2", "outWide": "2", "outHigh": "2", "outLong": "2", "competingGoodsPrice": "5",
     "inNetweight": 2, "finalFreight": "1", "airTransFee": "1", "seaTransFee": "1", "subUrl": []}]}
url = {"file": [{"url": url, "fileType": 0, "main": 1, "sourceType": 3}]}
json3 = {'sourceType': 2, 'productSellingPoint': '1111111', 'parentSku': FatherSKu, 'purchaser': '肖强',
         'radomDescriptionCn': 'qqqqqqq', 'estimatedMonthSale': 11, 'productLevel': 'A',
         'productFullCate': '汽车、摩托车(Automobiles & Motorcycles)>>力帆汽车销售(Auto Sale)', 'tagName': '', 'specialCount2': '',
         'itemUrl': 'http://www.ebay.com.dsds1111', 'suitTarget3': '', 'category_ids': '208,508', 'productNewId': id,
         'specialCount1': '', 'znProductName': simpleTitle, 'enProductTitle': 'a b c d e f g h i j k', 'status': -3,
         'cateIds': '208,508', 'fixedDescription': '', 'subSku': json.dumps(subsku), 'suitTarget1': '', 'suitTarget2': '',
         'competingGoodsMonthSales': 11, 'url': json.dumps(url), 'productCertificate': '',
         'keyword': 'a\nb\nc\nd\ne\nf\ng\nh\ni\nj\nk', 'specialCount3': '', 'radomDescription': 'pppppp',
         'aliasCnName': '1111', 'queryKey': '', 'salerName': '新品'}
json4 = {'sonData1': {'brand': '', 'packageCount': 0, 'goodsCategoryId': '508', 'sourceType': 2, 'purchaser': '肖强',
                      'itemUrl': 'http://www.ebay.com.dsds1111', 'StoreID': 17, 'specs': '', 'sampleCount': 0,
                      'SalerName': '新品', 'category_ids': '208,508', 'packName': '', 'AliasEnName': '1111',
                      'USEDueDate': '2069-05-31 11:21:46', 'MinNum': 1, 'goodAttrs': '7', 'notes': '',
                      'cateIds': '208,508', 'MaxNum': 1, 'SellDays': 2, 'CategoryCode': '208,508', 'unit': '',
                      'PackingRatio': 0, 'productCertificate': '', 'StockDays': 3, 'declaredValue': 1, 'GoodsCount': 0,
                      'selfMake': 0, 'packFee': 0, 'SalerName2': '刘畅', 'material': '', 'hscode': '1111',
                      'aliasCnName': '1111', 'originCountry': 'China'}, 'params2': [
    {'CostPrice': 2, 'seaTransFee': '1', 'competingGoodsPrice': '5', 'sku': FatherSKu, 'bmpFile': 'No Image',
     'goodsName': simpleTitle, 'outWide': '2', 'outHigh': '2', 'outLong': '2', 'specs': '', 'inLong': '2', 'inHigh': '2',
     'airTransFee': '1', 'inNetweight': 2, 'supportName': '永康市一心硅胶制品厂', 'inWide': '2', 'style': '', 'weight': 2,
     'supplierId': 17729,
     'linkUrl': 'https://detail.1688.com/offer/582177627118.html?spm=a26352.b28411319.offerlist.1.5d871e62VBZakz',
     'finalFreight': '1'}]}
