...
import string
# #登录获取token
a = request.Test_myRequest('https://papi.longpean.com/login/login', 'POST',
                           data={'mobile': '15214382625', 'password': 'lc123456789'})
...
#
# 获取返回token
data2 = {"bucket":"prod","envir":"test_tk"}
a=request.Test_myRequest('https://stpic.longpean.com//picture/token', 'POST',
                           data=data2)
...
data={"imageUrl": "http://pspk.longpean.com/"+m,"linkUrl":itemurl,"developType":0,"note": "","simpleTitle": simpleTitle,"productNature":0,"station":"", "detargetId":"","goodStore": 1,"dulizhanStore": 0,"amazonStore": 0}

a=request.Test_myRequest('https://papi.longpean.com/tProductNew/saveOrUpdateProductNew', 'POST',
...
a=request.Test_myRequest('https://papi.longpean.com/tProductNew/updateProductNewAuditBatch', 'POST',
...
a=request.Test_myRequest('https://papi.longpean.com/skuRules/getFatherSku', 'GET',
                           headers=headers)
...
a=request.Test_myRequest('https://papi.longpean.com/skuRules/getSku', 'POST',
...
#
# 获取返回token
data5 = {"bucket":"prod","envir":"test_tk"}
a=request.Test_myRequest('https://stpic.longpean.com//picture/token', 'POST',
                           data=data5)
...
url= "http://pspk.longpean.com/"+key
...
a=request.Test_myRequest('https://papi.longpean.com/tProductNew/saveProduct', 'POST',
...
a=request.Test_myRequest('https://papi.longpean.com/productParentSkuInfo/addProductFileAz', 'POST',
...
a=request.Test_myRequest('https://papi.longpean.com/productParentSkuInfo/addParentSku', 'POST',
...
print(data13)
a=request.Test_myRequest('https://papi.longpean.com/productParentSkuInfo/modifyGoodAttrs', 'POST',
...
print(data14)
a=request.Test_myRequest('https://papi.longpean.com/productParentSkuInfo/addCheckInfo', 'POST',
